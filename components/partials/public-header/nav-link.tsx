...
function NavLink({prefetch = false, ...props}: NavLinkProps) {
    ...
    console.log(props.pathName, props.href, props.pathName?.includes(props.href));
    return (
        ...
        >
            <Link
                prefetch={prefetch}
                href={props.href}
                className={cn("flex items-center font-medium transition-all",
                    ...
                    {props.activeSubMenu === props.name && (
                        ...
                        >
                            {props.subMenuItems?.map((subItem) => (
                                ...
                                >
                                        <span
                                            className="group-hover:bg-custom-gradient group-hover:text-transparent bg-clip-text">
                                            {subItem.name}
                                        </span>
                                </Link>
                            ))}
